...
user_counts = puzzle_attempts[puzzle_attempts["d"] > "2024-08-19 00:00:00.000"].groupby("u")["ones"].count()
print(user_counts[user_counts >= 100])
gods = user_counts[user_counts >= 100].index.to_list()
print(gods)
